...
return {
	keys = {
		...
		{ key = "T", mods = "LEADER", action = act.AdjustPaneSize({ "Down", 1 }) },
		...
		{ key = "K", mods = "LEADER", action = act.AdjustPaneSize({ "Right", 1 }) },
	},
	...
	key_tables = {
		copy_mode = {
			...
			{ key = "F", mods = "NONE", action = act.CopyMode({ JumpBackward = { prev_char = true } }) },
			{ key = "F", mods = "SHIFT", action = act.CopyMode({ JumpBackward = { prev_char = true } }) },
